...
public class Test015_UDP64_Mixed : ITestCase
{
    public int Id => 15;
    public string Name => "UDP64_Mixed";
    public int ExpectedDeltaSize => 40;
    public string[] Tags => new[] { "udp", "64b", "mixed", "xor" };
    public string? Description => "64B packet: 50% XOR-flipped";
