...
public class Test033_512_Vertical_2_by_14 : ITestCase
{
    public int Id => 33;
    public string Name => "D512_Vertical_2_by_14";
    public int ExpectedDeltaSize => 27; 
    public string[] Tags => new[] { "udp", "512b", "mixed", "xor", "vertical" };
    public string? Description => "512B packet: 2/16ths XOR-flipped vertical";
