...
public class Test027_UDP512_Mixed : ITestCase
{
    public int Id => 27;
    public string Name => "UDP512_Mixed";
    public int ExpectedDeltaSize => 264;
    public string[] Tags => new[] { "udp", "512b", "mixed", "xor" };
    public string? Description => "512B packet: 50% XOR-flipped";
