...
public class Test031_512_Vertical_2_by_2 : ITestCase
{
    public int Id => 31;
    public string Name => "D512_Vertical_2_by_2";
    public int ExpectedDeltaSize => 27; 
    public string[] Tags => new[] { "udp", "512b", "mixed", "xor", "vertical" };
    public string? Description => "512B packet: 50% XOR-flipped vertical";
